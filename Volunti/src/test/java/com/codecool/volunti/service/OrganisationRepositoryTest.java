...
public class OrganisationRepositoryTest extends AbstractServiceTest {
    ...
    public void setUp() {
        ...
        organisation2.setCountry("HUNGARY");
    ...
    public void test_OrganisationFirstFieldMissing_Should_Return_Exception(){
        ...
        organisation = new Organisation("", Category.TEACHING, "HUNGARY", "zipcode", "City", "Address", spokenLanguages, "Mission minimum 10 character", "Desc 1 min 3 character", "Desc 2 min 3 character");
        organisation = this.repository.save(organisation);
