...
public class UserRepositoryTest extends AbstractServiceTest {
    ...
    public void setUp(){
        ...
        organisation = new Organisation("Test 1", Category.TEACHING, "HUNGARY", "zipcode", "City", "Address", spokenLanguages, "Mission minimum 10 character", "Desc 1 min 3 character", "Desc 2 min 3 character");
